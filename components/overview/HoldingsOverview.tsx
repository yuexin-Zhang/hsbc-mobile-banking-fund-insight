    ...
    <div className="space-y-2">
      ...
      <div className="bg-white rounded-[3px] border border-[#ebeef0] shadow-sm overflow-hidden px-3 py-2 relative">
        <div className="flex items-center justify-between">
          ...
          {isAIGenerated && (
            <button className="absolute top-2 right-0 flex items-center gap-0.5 bg-[#f0ad4e] px-0.5 py-1 rounded-l-full active:opacity-80 transition-opacity cursor-pointer">
